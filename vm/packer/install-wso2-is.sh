...
keytool -genkey -alias wso2carbon -keyalg RSA -keysize 2048 -keystore $USER_HOME/wso2is/wso2is-7.1.0/repository/resources/security/keystore.p12 -storetype PKCS12 -dname "CN=is.wso2, OU=IAM,O=WSO2,L=SantaClara,S=California,C=US" -storepass wso2carbon -keypass wso2carbon -ext SAN=dns:localhost
keytool -export -alias wso2carbon -keystore $USER_HOME/wso2is/wso2is-7.1.0/repository/resources/security/keystore.p12 -storetype PKCS12 -file $USER_HOME/wso2is/wso2is-7.1.0/repository/resources/security/pkn.pem -storepass wso2carbon -noprompt
keytool -import -alias newcert -file $USER_HOME/wso2is/wso2is-7.1.0/repository/resources/security/pkn.pem -keystore $USER_HOME/wso2is/wso2is-7.1.0/repository/resources/security/client-truststore.p12 -storetype PKCS12 -storepass wso2carbon -noprompt
