...
export IDENTITY_DATABASE_NAME="WSO2IDENTITY_DB"
export SHARED_DATABASE_NAME="WSO2SHARED_DB"
export USER_DATABASE_NAME="WSO2USER_DB"

export IDENTITY_DB_SETUP_SCRIPT="${IS_DB_SCRIPTS_PATH}/identity/mssql.sql"
export CONSENT_DB_SETUP_SCRIPT="${IS_DB_SCRIPTS_PATH}/consent/mssql.sql"

export SHARED_DB_SETUP_SCRIPT="${IS_DB_SCRIPTS_PATH}/mssql.sql"

export USER_DB_SETUP_SCRIPT="${IS_DB_SCRIPTS_PATH}/mssql.sql"
